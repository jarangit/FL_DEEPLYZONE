        ...
        <div className="news_pop">
          ...
          <div className="news_pop_content">
            ...
            <p>
              ...
              subtracting the cancellation and the return of the item. This
              growth can be credited to the change in shopping trends, which has
              taken a digital route due to the pandemic, and also e-commerce
              shopping has
            </p>
          </div>
        </div>
